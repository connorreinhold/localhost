            ...
            items: [
                {
                    type: "pic",
                    number: 0,
                    source: `data:image/gif;base64,${this.props.navigation.state.params.source_one}`,
                    changed: false
                },
                {
                    type: 'pic',
                    number: 1,
                    source: `data:image/gif;base64,${this.props.navigation.state.params.source_two}`,
                    changed: false
                },
                {
                    type: 'pic',
                    number: 2,
                    source: `data:image/gif;base64,${this.props.navigation.state.params.source_three}`,
                    changed: false
                },
                {
                    type: 'pic',
                    number: 3,
                    source: `data:image/gif;base64,${this.props.navigation.state.params.source_four}`,
                    changed: false
                }
            ],
            modalVisible: false,
